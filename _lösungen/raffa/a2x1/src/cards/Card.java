 ...
 * @author  Michael Sch&auml;fers  ([UTF-8]:"Michael Schäfers");
 *          P1@Hamburg-UAS.eu 
...
public class Card implements Comparable<Card> {
    ...
    final static private long encodedVersion = 2___00001_003___2023_04_04__01L;
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
    ...
    public String getFullName() {;
        return String.format("%s %s", suit.name().toLowerCase(), rank.name().toLowerCase());
    }
    ...
    public enum Rank {
        ...
        /**
         * Die Methode {@link #incremented()} liefert den Wert des Karten-Ranges <em>(bzw. {@link #Rank})</em> der aktuellen Karte <em>(bzw. {@link Card})</em> erhöht um eins.
         ...
         * andernfalls der Wert 15 zurückgeliefert.
         * @return Wert <em>(bzw. {@link #Rank})</em> des aktuellen Karten-Ranges <em>(bzw. {@link #Rank})</em> erhöht um eins.
         */
         ...
         * dann wird (sofern enabled) eine Assertion-Exception ausgelöst,
         * andernfalls der Wert 1 zurückgeliefert.
